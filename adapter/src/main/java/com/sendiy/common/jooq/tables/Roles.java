...
import com.sendiy.common.jooq.tables.RolePermissions.RolePermissionsPath;
...
public class Roles extends TableImpl<RolesRecord> {
     ...
     */
    public final TableField<RolesRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(32), this, "");
