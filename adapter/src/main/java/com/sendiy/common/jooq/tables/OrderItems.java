...
public class OrderItems extends TableImpl<OrderItemsRecord> {
     ...
     */
    public final TableField<OrderItemsRecord, UUID> PRODUCT_ID = createField(DSL.name("product_id"), SQLDataType.UUID.nullable(false), this, "");
     ...
     */
    public final TableField<OrderItemsRecord, BigDecimal> PRICE = createField(DSL.name("price"), SQLDataType.NUMERIC(10, 2).nullable(false), this, "");

    /**
     * The column <code>public.order_items.added_at</code>.
     */
    public final TableField<OrderItemsRecord, LocalDateTime> ADDED_AT = createField(DSL.name("added_at"), SQLDataType.LOCALDATETIME(6), this, "");
    ...
    public List<ForeignKey<OrderItemsRecord, ?>> getReferences() {
        return Arrays.asList(Keys.ORDER_ITEMS__ORDER_ITEMS_ORDER_ID_FKEY, Keys.ORDER_ITEMS__ORDER_ITEMS_PRODUCT_ID_FKEY);
    }
    ...
    public ProductsPath products() {
        if (_products == null)
            _products = new ProductsPath(this, Keys.ORDER_ITEMS__ORDER_ITEMS_PRODUCT_ID_FKEY, null);
