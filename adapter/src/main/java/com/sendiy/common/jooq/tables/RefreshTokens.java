...
public class RefreshTokens extends TableImpl<RefreshTokensRecord> {
     ...
     */
    public final TableField<RefreshTokensRecord, String> TOKEN = createField(DSL.name("token"), SQLDataType.VARCHAR(512).nullable(false), this, "");

    /**
     * The column <code>public.refresh_tokens.expiry_date</code>.
     */
    public final TableField<RefreshTokensRecord, LocalDateTime> EXPIRY_DATE = createField(DSL.name("expiry_date"), SQLDataType.LOCALDATETIME(6), this, "");
